:PROPERTIES:
:DIR:      ~/Workspace/muse/source/attachment/images/identity/
:END:
#+TITLE: Identity disorders 2 – Monster Girl Encyclopedia
#+LANGUAGE: en
#+DATE: <2025-03-01 Sat>
#+SUBSTACK: https://thesolarprincess.substack.com/p/identity-disorders-part-2-monster

/This post in a follow-up to [[file:blog/en/identitydisorders.org][my previous investigation]] into identity disorders. You have to read it first./

Sometimes one gets “stuck” on a creative/research problem and can't work on it directly. One should then put it in the [[https://discoelysium.fandom.com/wiki/Thought_Cabinet][Thought Cabinet]] so it can solve itself. One occasionally feeds it random data and lets it ferment. One reads stuff, plays games, talks to people, all as the problem is watching one from the subconscious, absorbing, tugging on the strings, subtly guiding.
...
So when a trans girl on a Discord server admitted she was a [[https://mgewiki.moe/index.php/Holstaur][Holstaur (18+)]] otherkin, the problem in my subconscious switched, so to speak, to the front. Even if she seriously believes that she used to be a hentai monster in her past life, surely she can't claim to having known that since /before/ monster girls first appeared in the media?
...
Those three stories, plus a lot of random snippets from people who didn't give permission to mention them, show a clear pattern about how identity dysphoria develops with trans people. Trans women take the leap after they start HRT; puberty doesn't change anything. Trans men take the leap after puberty; HRT doesn't seem to matter at all.
...
This narrows the search significantly. Estradiol doesn't have that many non-genomic effects. In my last post, I mentioned that estradiol “normalizes” NMDA receptor function, but upon revisiting the papers I learned this from ( [[http://onlinelibrary.wiley.com/doi/10.1111/j.1582-4934.2004.tb00478.x/pdf][this]], [[https://www.ncbi.nlm.nih.gov/pmc/articles/PMC3480182/][this]], [[http://www.sciencedirect.com/science/article/pii/S0197458003000125][this]]) I can see that those are long-term genomic effects. Also, the experiments were done by performing oophorectomy on rats -- in other words, /removing/ estradiol and looking at the effects. I tried to take long breaks in my HRT, and nothing happened to my trauma or identity; estradiol woke the demons up, but removing estradiol didn't put them back to sleep. Whatever happened, those are not the droids we're looking for. We are only interested in the one membrane receptor that estradiol works on -- GPER1.
...
But so far the most likely culprit is the [[https://en.wikipedia.org/wiki/Hypothalamic%E2%80%93pituitary%E2%80%93adrenal_axis][HPA axis]]. It regulates stress reactions and fight-or-flight reflexes, which is what PTSD is made of. GPER1 [[https://pubmed.ncbi.nlm.nih.gov/31735968/][regulates it directly]] and rapidly. The interaction between GPER1 and HPA is [[https://pmc.ncbi.nlm.nih.gov/articles/PMC6129417/][modulated]] by allopregnanolone. “Modulated” is a wild card term in neuroscience that takes on whatever meaning makes the entire sentence true, but the end result is that allopregnanolone protects the HPA axis from some harmful effects of estradiol. [[https://pmc.ncbi.nlm.nih.gov/articles/PMC8197074/][Chronic stress leads to permanently lowered allopregnanolone levels]], which is sometimes considered a part of PTSD pathology. It doesn't matter much on a testosteronic metabolism, but if you add estradiol to the mix and don't have enough allopregnanolone, the HPA axis is overloaded and, apparently, causes all the suppressed trauma to resurface.
...
[[file:../../attachment/images/identity/estradiol.webp]]
...
In any case, there's a lot more to think about here. If any reader wants to start taking estradiol for the first time, [[mailto:inbox@thesolarprincess.site][email me]], we might have experiments to run.
